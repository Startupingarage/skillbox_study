...
enumeration = input('Введите 10 символов без пробелов "a","b", где это свободное или занятое стойло, соответвственно\n')
count = 0
total_liters = 0
...
print(f'Всего за день будет произведено {total_liters} литров молока')