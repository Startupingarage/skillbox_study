...
# Напишите программу, которая получает данные о количестве должников, а затем спрашивает у каждого пятого (начиная с нуля) его долг. 
...
debt_users = int(input('Введите количество должников: '))
summ_debt = 0

for i in range(0, debt_users, 5):
